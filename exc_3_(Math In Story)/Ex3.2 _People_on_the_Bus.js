...
function passengersNumberEndStation(arr,firstBusCount){
   let numbEnd=firstBusCount;
   arr.forEach((inOut)=>{
      return numbEnd =numbEnd+inOut[0]-inOut[1];
      
   })
   return numbEnd;
}

let allpassengers=20;
let bus_info=[[6,4],[3,27],[8,2],[11,7]];
console.log(passengersNumberEndStation(bus_info,allpassengers));
