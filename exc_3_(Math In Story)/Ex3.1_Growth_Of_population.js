...
function nb_years(pup0,growthPercent,aus_einziehen,pupGoal){
   let growth=(growthPercent/100)+1;
   let actualPup=pup0;
   let years=0;
   while(actualPup<=pupGoal){
      let yearlyCalc=actualPup*growth+aus_einziehen;
      actualPup= yearlyCalc;
      years +=1;
   }
   return Math.trunc(years);

}
console.log(nb_years(1500,5,100,5000));